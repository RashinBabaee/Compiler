...
static rs_intg transitionTable[][TABLE_COLUMNS] = {
	...
	{     1,     1,    8,    2, ESWR, 10,    8,  8,  1,  8}, // S1: NOAS
	...
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S8: ASWR (ER)
	{     3,     3,    9,   9,    9, 16,    9,  9,  3,  16}, // S9: NOAS	
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S10: ASWR (ER)
	{     12,   11, 13, ESNR,    12,  ESWR,  12,  12,  12,  12},  // S11: NOAS
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S12: ASNR (MVID)
	{     14,   13, ESNR, ESNR,    14,  ESWR,  14,  14,  14,  14},  // S13: NOAS
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S14: ASNR (MVID)
	{     15,   16, ESNR, ESNR,    16,  17,  16,  16,  15,  16},  // S15: NOAS
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S16: ASNR (MVID)
	{    FS,    FS,   FS,   FS,   FS,   FS,   FS,  FS,  FS,  FS}, // S17: ASWR (ER)
};
