 ...
 * -------------------------------------------------------------
 */
rs_void printScannerError(rs_char* fmt, ...);
rs_void displayScanner(BufferReader* ptrBuffer);
rs_long getScannerFilesize(rs_char* fname);
...
rs_intg mainScanner(rs_intg argc, rs_char** argv) {
